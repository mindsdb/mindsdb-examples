...
def run(sample):
    ...
    predictor.learn(from_data=train_file, to_predict=['sentiment'], disable_optional_analysis=True, use_gpu=True, backend=backend, sample_margin_of_error=0.1, unstable_parameters_dict={'force_disable_cache': False})
