...
def run(sample):
    ...
    mdb.learn(from_data='processed_data/train.csv', to_predict='diagnosis', use_gpu=True, backend=backend, stop_training_in_x_seconds=10, equal_accuracy_for_all_output_categories=True)
