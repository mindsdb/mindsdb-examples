...
def run(sample):
    ...
    mdb.learn(to_predict='default.payment.next.month',from_data=train_file, stop_training_in_x_seconds=800,backend=backend, sample_margin_of_error=0.1, equal_accuracy_for_all_output_categories=True, unstable_parameters_dict={'optimize_model':False}, use_gpu=True)
