...
class CreditDefault:
    ...
    def train_with_ludwig(self):
        ...
        train_stats = ludwig_model.train(data_train_csv="../../dataset/train.csv",
                                         model_name='default_credit')
        print(train_stats)

    def predict_train_with_ludwig(self):
        ludwig_model = LudwigModel.load("results/api_experiment_default_credit/model")
    ...
    def calculate_score(self):
        ...
        results = list(y_pred['default.payment.next.month_predictions'])
        real = list(y_true['default.payment.next.month'])
