...
class Electricity:
    ...
    def predict_train_with_ludwig(self):
        ludwig_model = LudwigModel.load("results/api_experiment_electricity/model")
    ...
    def calculate_score(self):
        ...
        y_true = pd.read_csv('dataset/test.csv', usecols=['power_consumed'])
        print(r2_score(list(y_true['power_consumed']), list(y_pred['power_consumed_predictions'])))
